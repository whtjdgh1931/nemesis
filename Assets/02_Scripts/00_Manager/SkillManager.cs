...
public class SkillManager : MonoBehaviour
{
    ...
    {
        // 현재 가지고 있는 기술 개수 + 1이 가중치가 됨 (0개면 1, 1개면 2, ...)
        ...
        // 기술팩을 다 뽑았고, 콜라보 기술 조건이 안되면 가중치 0 -> 출현 확률 0
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            #region skillThreeNum보다 작은 경우 Company3, skillFourNum보다 작은 경우 Company4, 나머지는 Company5
